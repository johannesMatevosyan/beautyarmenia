...
<table width="681" cellspacing="5">
	  ...
	  <tr>
	   <td> Նորության հակիրճ տեքստը:  </td>
		<td><textarea  name="heading" rows="2" cols="20"></textarea></td>
      </tr>
	  <tr>
	  ...
	  <tr>
		<td >Նկարի URL-ն&nbsp;:<span style="float:right"><?='http://'.$config->BASE_URL.'/';?></span></td>
		<td><input type="text" name = "picuri" value = "views/img/"/></td>
      </tr>
	  <tr>
	  <tr>
	    <td height="21" >Նորության լեզուն:</td>
	  ...
	  <tr>
	    <td height="21" >Նորության երեվալը:</td>
...
$('#position').load('ajax_get_pos_news.php',{lang : lang});
