...
<form method="post">
  ...
  <table width="588" height="225" cellspacing="10">
    <tr>
      ...
      <td width="132"><input type="text" name = "description" value = "<?=$cont['description'];?>"  size="40" /></td>
    </tr>
    <tr>
      <td>Փնտրող համակարգի համար բառեր: </td>
      <td><input type="text" name = "keywords" value = "<?=$cont['keywords'];?>"  size="40" /></td>
    </tr>
    <tr>
      <td>Էջի անունը:</td>
      <td><input type="text" name = "title" value = "<?=$cont['title'];?>" size="40"  /></td>
    </tr>
    <tr>
      <td>Նորության անունը:</td>
      <td><input type="text" name = "menu_name" value = "<?=$cont['menu_name'];?>"  size="40" /></td>
    </tr>
	<td>URL&nbsp;:</td>
      <td><input type="text" name = "uri" value = "<?='http://'.$config->BASE_URL.$cont['uri'];?>"  size="40" /></td>
    </tr>
	<tr>
	   <td> Նորության հակիրճ տեքստը:  </td>
		<td><textarea  name="heading" rows="2" cols="20" style="width: 100%"><?=$cont['heading'];?></textarea></td>
    </tr>
	<tr>
		<td >Նկարի URL-ն&nbsp;:</td>
		<td><input type="text" name = "picuri" value = "<?='http://'.$config->BASE_URL.$cont['picuri'];?>" size="40" /></td>
    </tr>
    <tr>
      <td>Մենյուի դիրքը:</td>
