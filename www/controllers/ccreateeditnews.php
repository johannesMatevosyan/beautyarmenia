<?php
	require_once "{$config->APP_PATH}/models/mcreateeditnews.php" ; // подключаем модель McreateEdit

	class CcreateEditNews extends McreateEditNews {
	...
	$vcreateedit = new CcreateEditNews() ;
